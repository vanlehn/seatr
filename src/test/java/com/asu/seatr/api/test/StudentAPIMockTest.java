...
@PrepareForTest({Student_UnansweredTasks.class, StudentAnalyzerHandler.class, StudentAPI_UnansweredTasks.class})
...
public class StudentAPIMockTest extends JerseyTest {
	...
	protected Application configure() {
		...
		return new ResourceConfig(StudentAPI_UnansweredTasks.class);
	}

	@Test
	public void getStudentTest_Success() throws CourseException, StudentException {
		Student_UnansweredTasks sa1 = new Student_UnansweredTasks();
		sa1.setId(1);		
		...
		final SAReader_UnansweredTasks resp = target(ANALYZER1_URL).queryParam("external_student_id", "23")
				.queryParam("external_course_id", "35").request().get(SAReader_UnansweredTasks.class);
	...
	public void createStudentTest() throws Exception   {
		...
		Student_UnansweredTasks s_a1 = PowerMockito.mock(Student_UnansweredTasks.class);						
		PowerMockito.whenNew(Student_UnansweredTasks.class).withNoArguments().thenReturn(s_a1);
		...
		PowerMockito.verifyNew(Student_UnansweredTasks.class).withNoArguments();
