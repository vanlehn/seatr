...
public class StudentTaskAPITest extends JerseyTest {
	...
	@Test
	public void test1StudentTaskCreate() {
	...
	@Test
    public void test2StudentTaskGet() {
        final STAReader1 resp = target("studenttasks/1").queryParam("external_student_id", "23")
        		.queryParam("external_course_id", "35").queryParam("external_task_id", "43").request().get(STAReader1.class);
	...
	@Test
    public void test3StudentTaskUpdate() {
    	Map<String, String> data = new HashMap<String, String>();
		data.put("external_student_id","23");
		data.put("external_course_id", "35");
		data.put("external_task_id","43");
		...
		final STAReader1 respGet = target("studenttasks/1").queryParam("external_student_id", "23")
        		.queryParam("external_course_id", "35").queryParam("external_task_id", "43").request().get(STAReader1.class);
	...
	@Test
	public void test4StudentTaskDelete() {
		...
		final Response respGet = target("studenttasks/1").queryParam("external_student_id", "23")
        		.queryParam("external_course_id", "35").queryParam("external_task_id", "43").request().get(Response.class);
