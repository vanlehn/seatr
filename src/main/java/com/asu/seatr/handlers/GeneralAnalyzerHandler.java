...
public class GeneralAnalyzerHandler<T> {

	private static GeneralAnalyzerHandler analyzerHandler;
	
	public static GeneralAnalyzerHandler getInstance(){
		if(analyzerHandler == null){
			analyzerHandler = new GeneralAnalyzerHandler();
		}
