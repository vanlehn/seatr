...
public interface StudentTaskAnalyzerI {
	...
	public void createStudentTask(String external_student_id, String external_course_id, String external_task_id, int analyzer_id) throws CourseException, TaskException;
