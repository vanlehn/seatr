...
public class ST_A1 implements StudentTaskAnalyzerI{
	...
	@Override
	public void createStudentTask(String external_student_id, Integer external_course_id, String external_task_id,
			int analyzer_id) {
	...
	@Override
	public void updateStudentTask(String external_student_id, Integer external_course_id, String external_task_id,
			int analyzer_id) {
		// TODO Auto-generated method stub
